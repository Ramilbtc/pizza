...
exports.setItems = exports.selectPizzaData = exports.fetchPizzas = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1["default"].get("https://63fc3ef6859df29986b8ebfe.mockapi.io/items?page=" + pageCount + "&limit=4&" + category + "&sortBy=" + sortBy + "&order=" + order + search)];
            case 1:
                data = (_a.sent()).data;
