...
var FullPizza = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, axios_1["default"].get('https://63fc3ef6859df29986b8ebfe.mockapi.io/items/' + id)];
                        case 1:
                            data = (_a.sent()).data;
                            setPizza(data);
                            return [3 /*break*/, 3];
    ...
    if (!pizza) {
        return react_1["default"].createElement(react_1["default"].Fragment, null, "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...");
    }
